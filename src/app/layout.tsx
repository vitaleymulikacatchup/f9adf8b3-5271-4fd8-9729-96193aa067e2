...
export const metadata: Metadata = {
  title: "YourAIStartup - Transform Your Business with AI",
  description: "Explore our innovative AI solutions to enhance efficiency and productivity in your business. Stay informed and connected with our latest updates.",
  openGraph: {
    title: "YourAIStartup - Transform Your Business with AI",
    description: "Explore our innovative AI solutions to enhance efficiency and productivity.",
    url: "",
    siteName: "YourAIStartup",
    images: [{ url: "https://images.pexels.com/photos/34234300/pexels-photo-34234300.png?auto=compress&cs=tinysrgb&h=650&w=940" }],
    type: "website",
  },
  twitter: {
